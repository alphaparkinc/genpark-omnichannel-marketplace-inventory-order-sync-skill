# genpark-omnichannel-marketplace-inventory-order-sync-skill
...
> **GenPark AI Agent Skill** -- Omnichannel multi-marketplace real-time inventory and order sync engine (SIRCLO style)
